...
const Prototype = () => {
    ...
    const [valueOne, setValueOne] = useState("1.01");
    const inputOne = (e) => {
    ...
    const [valueTwo, setValueTwo] = useState("1.01");
    const inputTwo = (e) => {
        const inputValue = e.target.value;
        // regex to match only numbers and one decimal point
        const regex = /^[0-9]*\.?[0-9]*$/;
    ...
    function crossPollinationExchangeSystem(){
        ...
        //****Base Case issue: EnterValidTokens not responding for input two */
        //Base Cases
